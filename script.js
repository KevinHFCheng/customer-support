 ...
 *   3. i18n 新增 specApproxNotice 三語系文案，對應波長查詢無精確符合結果時的提示。
 */
...
const i18n = {
    'zh-TW': {
        ...
        labelProduct: '產品型號',
        placeholderModelEx: '例如：SE2030-050-VNIR',
        labelSN: '產品序號（S/N）',
        ...
        resModelCode: '機型代碼',
        resSensorCode: '感測器代碼',
        resSensorLength: '感測器長度',
        resPixels: '像素',
        resSensorInfo: '感測器資訊',
        resSheetLoc: '試算表定位',
        btnBackHome: '返回主頁',
        specLoading: '正在搜尋中，請稍候...',
        specQueryTitle: '查詢條件輸入',
        specWavelengthSection: '波長條件（選填，填入後將自動查詢解析度）',
        specLoadingSub: '連接 GAS 後端並比對試算表資料',
        specResultFullTable: '規格表完整資料',
        specResultMeet: '滿足波長條件的波段與解析度',
        specResultHint: '波段查詢提示',
        specNoData: '在波長範圍內查無符合的波段與解析度資料',
        specApproxNotice: '查無完全符合波長範圍的波段，以下為最接近的搜尋結果',
        specTableBandName: '波段名',
        specTableBandRange: '波段範圍',
        specMeetBadge: '符合',
        errModelFormat: '型號格式錯誤，需至少 6 碼（例：SE2030）',
        errSystem: '系統錯誤：',
        errNoSensor: '找不到對應感測器資訊',
        btnSearching: '查詢中...'
    },
    'zh-CN': {
        pageTitle: '客户需求与问题登记',
        ...
        labelUpload: '附件上传（最多 5 个）',
        uploadHint: '文件将自动存入云端文件夹',
        btnSubmit: '提交需求',
        chatTitle: 'AI 智能客服',
        chatWelcome: '您好！我是您的智能助手。有任何关于技术规格或 FAQ 的问题都可以问我喔！',
        chatPlaceholder: '请输入问题...',
        chatSend: '发送',
        chatError: '系统连线错误，请稍候再试。',
        alertExceedLimit: '最多仅限 5 个附件！',
        btnSubmitting: '提交中...',
        ...
        specTitle: '波长范围与解析度',
        specSubtitle: '请输入产品型号以查询对应的感测器信息',
        labelModel: '1. 产品型号',
        ...
        resModelCode: '机型代码',
        resSensorCode: '感测器代码',
        resSensorLength: '感测器长度',
        resPixels: '像素',
        resSensorInfo: '感测器信息',
        resSheetLoc: '试算表定位',
        btnBackHome: '返回主页',
        specLoading: '正在搜寻中，请稍候...',
        specQueryTitle: '查询条件输入',
        specWavelengthSection: '波长条件（选填，填入后将自动查询解析度）',
        specLoadingSub: '连接 GAS 后端并对比试算表数据',
        specResultFullTable: '规格表完整数据',
        specResultMeet: '满足波长条件的波段与解析度',
        specResultHint: '波段查询提示',
        specNoData: '在波长范围内查无符合的波段与解析度数据',
        specApproxNotice: '查无完全符合波长范围的波段，以下为最接近的搜索结果',
        specTableBandName: '波段名',
        specTableBandRange: '波段范围',
        specMeetBadge: '符合',
        errModelFormat: '型号格式错误，需至少 6 码（例：SE2030）',
        errSystem: '系统错误：',
        errNoSensor: '找不到对应感测器信息',
        btnSearching: '查询中...'
    },
    'en': {
        ...
        placeholderModelEx: 'e.g. SE2030-050-VNIR',
        ...
        chatSend: 'Send',
        chatError: 'System connection error, please try again later.',
        ...
        resSensorLength: 'Sensor Length',
        resPixels: 'Pixels',
        resSensorInfo: 'Sensor Info',
        resSheetLoc: 'Sheet Location',
        btnBackHome: 'Back to Home',
        specLoading: 'Searching, please wait...',
        specQueryTitle: 'Query Conditions',
        specWavelengthSection: 'Wavelength Conditions (Optional, automatically queries resolution after entry)',
        specLoadingSub: 'Connecting to GAS backend and verifying spreadsheet data',
        specResultFullTable: 'Full Specification Table',
        specResultMeet: 'Waveband & Resolution Meeting Wavelength Conditions',
        specResultHint: 'Waveband Query Hint',
        specNoData: 'No matching waveband and resolution data found within the wavelength range',
        specApproxNotice: 'No waveband exactly matches the requested range — showing the closest available result',
        specTableBandName: 'Band Name',
        specTableBandRange: 'Band Range',
        specMeetBadge: 'Meet',
        errModelFormat: 'Invalid model format, at least 6 characters required (e.g. SE2030)',
        errSystem: 'System Error: ',
        errNoSensor: 'Sensor information not found',
